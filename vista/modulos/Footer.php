...
<footer class="footer has-cards">
  <div class="row">
    ...
    <div class="col-md-6 col-lg-4 mb-5 mb-lg-0">
      <div class="px-4">
        <img src="vista/presentacion/img/adriana.jpg" class="rounded-circle img-center img-fluid shadow shadow-lg--hover" style="width: 200px;">
        <div class="pt-4 text-center">
          <h5 class="title">
  ...
  <div class="row">
    <div class="col-md-6 col-lg-4 mb-5 mb-lg-0">
      <div class="px-4">
        <img src="vista/presentacion/img/adrian.jpg" class="rounded-circle img-center img-fluid shadow shadow-lg--hover" style="width: 200px;">
        <div class="pt-4 text-center">
          <h5 class="title">
            <span class="d-block mb-1">Integrante 4</span>
            <small class="h6 text-muted">Documentador</small>
          </h5>
          <div class="mt-3">
            <a href="#" class="btn btn-warning btn-icon-only rounded-circle">
    ...
    <div class="col-md-6 col-lg-4 mb-5 mb-lg-0">
      <div class="px-4">
        <img src="vista/presentacion/img/danilo.jpg" class="rounded-circle img-center img-fluid shadow shadow-lg--hover" style="width: 200px;">
        <div class="pt-4 text-center">
          <h5 class="title">
            <span class="d-block mb-1">Integrante 5</span>
            <small class="h6 text-muted">Desarrollador Web</small>
          </h5>
          <div class="mt-3">
            <a href="#" class="btn btn-primary btn-icon-only rounded-circle">
